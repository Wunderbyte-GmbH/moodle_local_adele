...
$string['error_condition_no_node_selected'] = '[' . __LINE__ . ']A "specific node completed" access criterion on node "{$a}" has no node selected. Please select a node before saving.';

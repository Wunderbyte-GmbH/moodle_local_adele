...
$string['course_restricition_before_condition_manual'] = 'FEEDABACK manual before !';
...
$string['course_restricition_before_condition_parent_courses'] = 'FEEDABACK before !';
...
$string['course_description_before_completion_manual'] = 'granted manually before';
$string['course_description_inbetween_completion_manual'] = 'Check will be granted manually';
$string['course_description_after_completion_manual'] = 'granted manually after';
...
$string['course_restricition_before_condition_specific_course'] = 'FEEDABACK before !';
$string['course_name_condition_restriction_specific_course'] = 'Certain course completed';
$string['course_description_condition_timed'] = 'Course start date; Course end date';
$string['course_restricition_before_condition_timed'] = 'FEEDBACK Course start date; Course end date, before!';
$string['course_name_condition_timed'] = 'Course start/end date';
$string['course_description_condition_course_completed'] = 'One course inside this node has to be completed by student';
$string['course_description_before_condition_course_completed'] = 'One course inside this node feedback before';
$string['course_description_after_condition_course_completed'] = 'One course inside this node feedback after';
$string['course_description_inbetween_condition_course_completed'] = 'Current best completion grade: {course progress}%';
$string['course_name_condition_course_completed'] = 'One course completed';
$string['course_description_condition_catquiz'] = 'Accroding to catquiz results/attempts';
$string['course_description_before_condition_catquiz'] = 'catquiz results/attempts feedback before';
$string['course_description_inbetween_condition_catquiz'] = 'Current best cat quiz results: {best catquiz}';
$string['course_description_after_condition_catquiz'] = 'catquiz results/attempts feedback after';
...
$string['course_description_before_condition_modquiz'] = 'modquiz results/attempts feedback before';
$string['course_description_inbetween_condition_modquiz'] = 'Current best quiz attempt: {best quiz}';
$string['course_description_after_condition_modquiz'] = 'modquiz results/attempts feedback after';
...
$string['course_restricition_before_condition_parent_node_completed'] = 'FEEDABACK before !';
...
$string['course_restricition_before_condition_timed_duration'] = 'FEEDBACK Course time duration, before!';

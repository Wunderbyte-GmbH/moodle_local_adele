...
class learninggoal_edit extends \moodleform {
    ...
    public function definition() {
        ...
        /** @var \local_adele\adele $adele */
        $adele = $this->_customdata['adele'];

        /** @var int $learninggoalid */
        $learninggoalid = $this->_customdata['learninggoalid'];

        // General section header.
        $mform->addElement('header', 'general', get_string('learninggoal', 'local_adele'));
        ...
        // Name.
        $mform->addElement('text', 'name', get_string('learninggoal_name', 'local_adele'));
        $mform->addRule('name', get_string('required'), 'required');
        $mform->setType('name', PARAM_TEXT);

        // Description.
        $mform->addElement('text', 'description', get_string('learninggoal_description', 'local_adele'));

...
class handlers extends external_api {
    ...
    public static function get_handlers($userid, $learninggoalid) {
        ...
        $sql = "SELECT 0 AS id, '" . get_string('thinkingskill', 'local_adele') . "' AS tabtitle, '#009' AS tabcolor,
                    'ts' AS tabprefix, 'thinking_skill' AS targetinput
                UNION
                SELECT 1 AS id, '" . get_string('content', 'local_adele') . "' AS tabtitle, '#600' AS tabcolor,
                    'c' AS tabprefix, 'content' AS targetinput
                UNION
                SELECT 2 AS id, '" . get_string('resources', 'local_adele') . "' AS tabtitle, '#090' AS tabcolor,
                    'r' AS tabprefix, 'resource' AS targetinput
                UNION
                SELECT 3 AS id, '" . get_string('products', 'local_adele') . "' AS tabtitle, '#909' AS tabcolor,
                    'p' AS tabprefix, 'product' AS targetinput
                UNION
                SELECT 4 AS id, '" . get_string('groups', 'local_adele') . "' AS tabtitle, '#990' AS tabcolor,

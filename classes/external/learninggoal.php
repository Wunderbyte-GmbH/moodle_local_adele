...
/**
 * Handling with a adele learning goal.
 *
 * @package     local_adele
...
use local_adele\external\exporter\bool_dto;
...
class learninggoal extends external_api {
    ...
    public static function get_learninggoal($userid, $learninggoalid) {
        ...
        if ($learninggoalid > 0) {
            ...
            $sql = "SELECT 0 AS id, '" .
                get_string('clicktoedit', 'local_adele') . "' AS \"name\", " .
                "'' AS \"description\", '" .
                get_string('prethinkingskill', 'local_adele') . "' AS \"pre_thinking_skill\", " .
                ...
                "\"content\", '" .
                get_string('clicktoedit', 'local_adele') . "' AS \"subject\", '" .
                get_string('preresource', 'local_adele') . "' AS \"pre_resource\", " .
                "(SELECT rwetext from {local_differentiator_rwe} WHERE rwid = 1 AND lang = '" . $SESSION->lang . "') AS " .
                "\"resource\", '" .
                get_string('preproduct', 'local_adele') . "' AS \"pre_product\", " .
                "(SELECT pwetext from {local_differentiator_pwe} WHERE pwid = 37 AND lang = '" . $SESSION->lang . "') AS " .
                "\"product\", '" .
                get_string('pregroup', 'local_adele') . "' AS \"pre_group\", " .
